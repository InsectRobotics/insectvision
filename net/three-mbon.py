...
class Neuron(object):
    ...
    def __fprop(self, odour, shock):
        ...
        # self._c_odour[~i] += self._u_odour[~i]
        # self._c_shock += self._u_shock * odour * shock
        # self._c_shock -= self._u_shock * odour * (1. - shock)
...
class Network(object):
    ...
    def __update(self, odour, shock):
        ...
        # collect MBON values
        m = np.array([m.v for m in self._mbon])

        # update DAN values using previous MBON values
        # and collect DAN values
        ...
        # update and recollect MBON values
